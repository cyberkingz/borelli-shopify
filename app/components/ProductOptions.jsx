...
export function ProductOptions({
  ...
  const isSize = option.name.toLowerCase() === 'size' || option.name.toLowerCase() === 'shoe size' || option.name.toLowerCase() === 'größe' || option.name.toLowerCase() === 'taille' || option.name.toLocaleLowerCase() === 'pointure' || option.name.toLocaleLowerCase() === 'schuhgröße';
      ...
      <div className="flex flex-col gap-2">
        {option.name.toLowerCase() === 'color' || option.name.toLowerCase() === 'farbe' || option.name.toLowerCase() === 'couleur' ? (
          ...
          <div className="flex items-center justify-between w-full sm:max-w-[300px]">
            ...
            {option.name.toLowerCase() === 'size' || option.name.toLowerCase() === 'größe' || option.name.toLowerCase() === 'taille' || option.name.toLocaleLowerCase() === 'pointure' || option.name.toLocaleLowerCase() === 'schuhgröße' && (
